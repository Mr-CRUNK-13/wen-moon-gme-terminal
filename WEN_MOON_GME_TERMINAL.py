    ...
    with st.container():
        ...
        def create_pdf_report():
            ...
            try:
                ...
                w1 = [30, 50, 50, 50]
                for i in range(4): pdf.cell(w1[i], 8, h1[i], border=1, align="C")
                pdf.ln()
                ...
                hist_data = [
                    ...
                    ["2022", "$5.15B", "-$315.1M", "-$365.8M"],
                    ["2021", "$4.28B", "-$199.3M", "-$215.1M"],
                    ["2020", "$4.71B", "-$275.3M", "-$279.7M"],
                ...
                w3 = [60, 60, 60]
                for i in range(3): pdf.cell(w3[i], 8, h3[i], border=1, align="C")
                pdf.ln()
                pdf.set_font("Arial", "", 10)
                store_data = [
        ...
        if pdf_bytes:
            ...
            st.warning("⚠️ LIBRARIES MISSING: Please add 'fpdf2' and 'pytz' to your requirements.txt")
