    ...
    def render_content():
        ...
        with ph9.container():
            ...
            with ptab3:
                ...
                html_store = "<div class='table-wrapper' style='margin-bottom: 90px;'><table class='opt-t' style='font-size: 20px; line-height: 1.4;'><tr><th>Fiscal Year</th><th>Total Revenue</th><th>Store Count</th><th>Revenue per Store</th></tr>"
                for r in store_data:
        ...
        with ph11.container():
            ...
            with fin_t2:
                ...
                hist_data = [
                    ...
                    {"p": "Q3 2025", "ee": 0.20, "ae": 0.24, "er": "987.28M", "ar": "821.0M", "fy": False},
