...
# --- 3. TERMINAL & LIVE ENGINE ---
    ...
    with tab19:
        ...
        st.markdown("<p style='text-align:center; color:#ccc; font-size:18px;'>Absolute transparency. The WEN MOON Terminal is 100% Open Source. No hidden trackers, no external databases. Your data stays on your device.</p>", unsafe_allow_html=True)
        st.markdown("<br>", unsafe_allow_html=True)
        ...
        <div style="display: flex; justify-content: center; margin-top: 20px; margin-bottom: 40px;">
            <a href="https://github.com/Mr-CRUNK-13/wen-moon-gme-terminal" target="_blank" style="text-decoration: none;">
                <div style="background-color: #0f172a; border: 2px solid #00FF00; box-shadow: 0 0 20px #00FF00; border-radius: 10px; padding: 20px 40px; display: inline-flex; align-items: center; justify-content: center;">
                    <span style="color: #00FF00; font-family: monospace; font-size: 22px; font-weight: bold;">🔍 INSPECT SOURCE CODE ON GITHUB</span>
                </div>
            </a>
        </div>
        """
        st.markdown(github_btn, unsafe_allow_html=True)
