...
# --- 3. TERMINAL & LIVE ENGINE ---
    ...
    with tab14:
        ...
        with w_t1: st.markdown(portal_btn("GAMESTOP INVESTORS", "Official corporate information.", "https://investor.gamestop.com/") + portal_btn("SEC EDGAR DATABASE", "Official SEC filings and reports.", "https://www.sec.gov/cgi-bin/browse-edgar?action=getcompany&CIK=0001326380&owner=include&count=40&hidefilings=0"), unsafe_allow_html=True)
