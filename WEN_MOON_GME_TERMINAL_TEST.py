...
st.set_page_config(page_title="GME TERMINAL", page_icon="logo_gme.jpg", layout="wide", initial_sidebar_state="collapsed")
...
with st.sidebar:
    ...
    <script>
        ...
        if (!nav) {
            ...
            nav.id = 'floating-nav';
            nav.style = "position:fixed; bottom:55px; right:6px; z-index:99999; display:flex; flex-direction:column; gap:4px; transition: opacity 0.5s; opacity: 1;";
...
<style>
    ...
    .title-container { text-align: center; margin-bottom: 20px; margin-top: 50px; }
...
if not st.session_state.launched and not st.session_state.show_leaderboard:
    ...
    with st.container():
        ...
        with st.container():
            ...
            st.markdown("<div style='width: 100%; text-align: center; margin-top: 10px;'><span style='font-family: monospace; font-size: 22px; font-weight: bold; animation: neon-text 1.5s infinite; color: #00FF00;'>By Mr-CRUNK-13</span></div>", unsafe_allow_html=True)
            st.markdown("<br>", unsafe_allow_html=True)
        ...
        def create_pdf_report():
            ...
            # --- 2. DATA FETCHING (HYBRID FALLBACK ENGINE) ---
            try:
                info = {}
                try:
                    tk = yf.Ticker("GME")
                ...
                pdf.cell(0, 5, f"Generated by WEN MOON TERMINAL - {ny_time}", ln=1, align="C")
                pdf.ln(5)
                ...
                # --- 5. HISTORICAL FINANCIALS (2019-2025) ---
...
# --- 3. TERMINAL & LIVE ENGINE ---
    ...
    with tab16:
        ...
        <style>
            ...
            @media screen and (orientation: portrait) {
                .neon-video { aspect-ratio: 16 / 9 !important; height: auto !important; }
            }
            @media screen and (orientation: landscape) {
                .neon-video { height: 400px !important; }
            }
        </style>
        <iframe class="neon-video" width="100%" src="https://www.youtube.com/embed/021_zhXd8T0" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        """, unsafe_allow_html=True)
    ...
    def render_content():
        ...
        with ph9.container():
            ...
            with ptab3:
                ...
                .opt-t th { background: #001f3f; color: #00FF00; padding: 9px 12px; border-bottom: 2px solid #0259c7; white-space: nowrap; font-size: 20px; }
                .opt-t td { background: #0f172a; padding: 8px 12px; border-bottom: 1px solid #0259c7; white-space: nowrap; font-size: 20px; }
                </style>
                """, unsafe_allow_html=True)
                ...
                for r in eps_data:
                    html_eps += f"<tr><td>{r['Year']}</td>"
                    for q in ["Q1", "Q2", "Q3", "Q4", "Total"]:
                        val = r[q]
                        c = "rgba(0, 255, 0, 0.25)" if val > 0 else "rgba(255, 0, 0, 0.25)" if val < 0 else "transparent"
                        html_eps += f"<td style='background-color:{c}; color:white; font-size:20px; font-weight:bold;'>{'+' if val > 0 else '-' if val < 0 else ''}${abs(val):.2f}</td>"
                    html_eps += "</tr>"
                html_eps += "</table></div>"
        ...
        with ph11.container():
            ...
            with fin_t1:
                ...
                rev_7 = [6466300000, 5089800000, 6010700000, 5927100000, 5272800000, 3823000000, 3629900000]
                net_7 = [-470900000, -215300000, -381300000, -313100000, 6700000, 131300000, 418400000]
                ...
                .fy-table td.bg-pos { background-color: #00FF00 !important; color: #000000 !important; font-size: 15px !important; padding: 2px 3px !important; }
                .fy-table td.bg-neg { background-color: #FF3333 !important; color: #000000 !important; font-size: 15px !important; padding: 2px 3px !important; }
                .fy-table td.bg-dark { background-color: #0f172a !important; color: #FFFFFF !important; }
                </style>
                
                <div class="fy-wrapper">
                    <table class="fy-table">
                        <tr><th>2025</th><th>Q1</th><th>Q2</th><th>Q3</th><th>Q4</th><th>FY 2025</th><th>% of revenue</th></tr>
                        <tr><td class="bg-dark">Hardware and accessories</td><td class="bg-pos">$345M</td><td class="bg-pos">$592M</td><td class="bg-pos">$367M</td><td class="bg-pos">$535.6M</td><td class="bg-pos">$1,840.4M</td><td class="bg-pos">50,70</td></tr>
                        <tr><td class="bg-dark">Software revenue</td><td class="bg-pos">$175M</td><td class="bg-pos">$152M</td><td class="bg-pos">$198M</td><td class="bg-pos">$203.7M</td><td class="bg-pos">$729.3M</td><td class="bg-pos">20,09</td></tr>
                        <tr><td class="bg-dark">Collectibles revenue</td><td class="bg-pos">$211M</td><td class="bg-pos">$228M</td><td class="bg-pos">$256M</td><td class="bg-pos">$365.0M</td><td class="bg-pos">$1,060.2M</td><td class="bg-pos">29,21</td></tr>
                        <tr><td class="bg-dark">Total Revenue</td><td class="bg-pos">$731M</td><td class="bg-pos">$972M</td><td class="bg-pos">$821M</td><td class="bg-pos">$1,104.3M</td><td class="bg-pos">$3,629.9M</td><td class="bg-pos">100</td></tr>
                        <tr><td class="bg-dark">Cost of sales</td><td class="bg-neg">($479.6M)</td><td class="bg-neg">($689.1M)</td><td class="bg-neg">($547.6M)</td><td class="bg-neg">($717.5M)</td><td class="bg-neg">($2,433.8M)</td><td class="bg-neg">(67,05)</td></tr>
                        <tr><td class="bg-dark">Operating costs</td><td class="bg-neg">($228.1M)</td><td class="bg-neg">($218.8M)</td><td class="bg-neg">($221.4M)</td><td class="bg-neg">($241.5M)</td><td class="bg-neg">($910.2M)</td><td class="bg-neg">(25,07)</td></tr>
                        <tr><td class="bg-dark">Operating income (losses)</td><td class="bg-neg">($10.8M)</td><td class="bg-pos">$66.4M</td><td class="bg-pos">$41.3M</td><td class="bg-pos">$135.2M</td><td class="bg-pos">$232.1M</td><td class="bg-pos">6,39</td></tr>
                        <tr><td class="bg-dark">Interest income</td><td class="bg-pos">$56.9M</td><td class="bg-pos">$79.6M</td><td class="bg-pos">$49.0M</td><td class="bg-pos">$86.0M</td><td class="bg-pos">$271.5M</td><td class="bg-pos">7,48</td></tr>
                        <tr><td class="bg-dark">Unreal. gains (losses) BTC</td><td class="bg-dark"></td><td class="bg-pos">$28.6M</td><td class="bg-neg">($9.2M)</td><td class="bg-neg">($151.0M)</td><td class="bg-neg">($131.6M)</td><td class="bg-neg">(3,63)</td></tr>
                        <tr><td class="bg-dark">Net income</td><td class="bg-pos">$44.8M</td><td class="bg-pos">$168.6M</td><td class="bg-pos">$77.1M</td><td class="bg-pos">$127.9M</td><td class="bg-pos">$418.4M</td><td class="bg-pos">11,53</td></tr>
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$6,400M</td><td class="bg-pos">$8,700M</td><td class="bg-pos">$8,800M</td><td class="bg-pos">$9,013M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($1,315M)</td><td class="bg-neg">($4,160M)</td><td class="bg-neg">($4,400M)</td><td class="bg-neg">($4,164M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>

                <div class="fy-wrapper">
                    <table class="fy-table">
                        <tr><th>2024</th><th>Q1</th><th>Q2</th><th>Q3</th><th>Q4</th><th>FY 2024</th><th>% of revenue</th></tr>
                        <tr><td class="bg-dark">Hardware and accessories</td><td class="bg-pos">$505.3M</td><td class="bg-pos">$451.2M</td><td class="bg-pos">$417.4M</td><td class="bg-pos">$725.1M</td><td class="bg-pos">$2,099.0M</td><td class="bg-pos">54,9</td></tr>
                        <tr><td class="bg-dark">Software revenue</td><td class="bg-pos">$239.7M</td><td class="bg-pos">$207.7M</td><td class="bg-pos">$271.8M</td><td class="bg-pos">$285.8M</td><td class="bg-pos">$1,005.0M</td><td class="bg-pos">26,3</td></tr>
                        <tr><td class="bg-dark">Collectibles revenue</td><td class="bg-pos">$136.8M</td><td class="bg-pos">$139.4M</td><td class="bg-pos">$171.1M</td><td class="bg-pos">$271.7M</td><td class="bg-pos">$719.0M</td><td class="bg-pos">18,8</td></tr>
                        <tr><td class="bg-dark">Total Revenue</td><td class="bg-pos">$881.8M</td><td class="bg-pos">$798.3M</td><td class="bg-pos">$860.3M</td><td class="bg-pos">$1,282.6M</td><td class="bg-pos">$3,823.0M</td><td class="bg-pos">100</td></tr>
                        <tr><td class="bg-dark">Cost of sales</td><td class="bg-neg">($637.3M)</td><td class="bg-neg">($549.5M)</td><td class="bg-neg">($603.1M)</td><td class="bg-neg">($919.2M)</td><td class="bg-neg">($2,709.1M)</td><td class="bg-neg">(70,91)</td></tr>
                        <tr><td class="bg-dark">Operating costs</td><td class="bg-neg">($295.1M)</td><td class="bg-neg">($270.8M)</td><td class="bg-neg">($282.0M)</td><td class="bg-neg">($282.5M)</td><td class="bg-neg">($1,130.4M)</td><td class="bg-neg">(29,59)</td></tr>
                        <tr><td class="bg-dark">Operating income (losses)</td><td class="bg-neg">($50.6M)</td><td class="bg-neg">($22.0M)</td><td class="bg-neg">($24.8M)</td><td class="bg-pos">$78.3M</td><td class="bg-neg">($19.1M)</td><td class="bg-neg">(0,50)</td></tr>
                        <tr><td class="bg-dark">Interest income</td><td class="bg-pos">$18.4M</td><td class="bg-pos">$36.8M</td><td class="bg-pos">$42.2M</td><td class="bg-pos">$53.0M</td><td class="bg-pos">$150.4M</td><td class="bg-pos">3,94</td></tr>
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$1,083.0M</td><td class="bg-pos">$4,204.0M</td><td class="bg-pos">$4,616.0M</td><td class="bg-pos">$4,775.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($26.0M)</td><td class="bg-neg">($23.0M)</td><td class="bg-neg">($20.0M)</td><td class="bg-neg">($17.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                ...
                <div class="fy-wrapper">
                    <table class="fy-table">
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$1,310.0M</td><td class="bg-pos">$1,195.0M</td><td class="bg-pos">$1,210.0M</td><td class="bg-pos">$1,199.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($26.0M)</td><td class="bg-neg">($24.0M)</td><td class="bg-neg">($20.0M)</td><td class="bg-neg">($18.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                ...
                <div class="fy-wrapper">
                    <table class="fy-table">
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$1,035.0M</td><td class="bg-pos">$909.0M</td><td class="bg-pos">$1,042.0M</td><td class="bg-pos">$1,391.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($36.0M)</td><td class="bg-neg">($32.0M)</td><td class="bg-neg">($29.0M)</td><td class="bg-neg">($29.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                ...
                <div class="fy-wrapper">
                    <table class="fy-table">
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$752.0M</td><td class="bg-pos">$1,720.0M</td><td class="bg-pos">$1,413.0M</td><td class="bg-pos">$1,271.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($216.0M)</td><td class="bg-neg">($48.0M)</td><td class="bg-neg">($45.0M)</td><td class="bg-neg">($41.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                ...
                <div class="fy-wrapper">
                    <table class="fy-table">
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$570.0M</td><td class="bg-pos">$746.0M</td><td class="bg-pos">$587.0M</td><td class="bg-pos">$619.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($420.0M)</td><td class="bg-neg">($216.0M)</td><td class="bg-neg">($216.0M)</td><td class="bg-neg">($216.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                ...
                <div class="fy-wrapper">
                    <table class="fy-table">
                        ...
                        <tr><td class="bg-dark">Hardware and accessories</td><td class="bg-pos">$755.7M</td><td class="bg-pos">$628.1M</td><td class="bg-pos">$702.6M</td><td class="bg-pos">$1,071.6M</td><td class="bg-pos">$3,158.0M</td><td class="bg-pos">48,8</td></tr>
                        <tr><td class="bg-dark">Software revenue</td><td class="bg-pos">$616.8M</td><td class="bg-pos">$512.5M</td><td class="bg-pos">$573.4M</td><td class="bg-pos">$874.4M</td><td class="bg-pos">$2,577.1M</td><td class="bg-pos">39,9</td></tr>
                        <tr><td class="bg-dark">Collectibles revenue</td><td class="bg-pos">$175.0M</td><td class="bg-pos">$145.4M</td><td class="bg-pos">$162.7M</td><td class="bg-pos">$248.1M</td><td class="bg-pos">$731.2M</td><td class="bg-pos">11,3</td></tr>
                        ...
                        <tr><td class="bg-dark">Total cash</td><td class="bg-pos">$543.0M</td><td class="bg-pos">$424.0M</td><td class="bg-pos">$291.0M</td><td class="bg-pos">$500.0M</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="bg-neg">($469.0M)</td><td class="bg-neg">($419.0M)</td><td class="bg-neg">($419.0M)</td><td class="bg-neg">($420.0M)</td><td class="bg-dark"></td><td class="bg-dark"></td></tr>
                    </table>
                </div>
                """
            ...
            with fin_t2:
                ...
                .crunk-table th:last-child, .crunk-table td:last-child { border-right: none; }
                .crunk-table tr:last-child td { border-bottom: none; }
                .crunk-table td:first-child { text-align: left; background-color: #0f172a; }
                .crunk-table td.bg-pos { background-color: #00FF00 !important; color: #000000 !important; font-size: 15px !important; padding: 2px 3px !important; }
                .crunk-table td.bg-neg { background-color: #FF3333 !important; color: #000000 !important; font-size: 15px !important; padding: 2px 3px !important; }
                .crunk-table td.bg-dark { background-color: #0f172a !important; color: #FFFFFF !important; }
                .crunk-blue { background-color: rgba(2, 89, 199, 0.4) !important; color: transparent !important; }
                </style>
                
                <div class="crunk-wrapper">
                    <table class="crunk-table">
                        <tr><th>2026</th><th>Q1</th><th>Q2</th><th>Q3</th><th>Q4</th><th>FY 2026</th><th>% of revenue</th></tr>
                        <tr><td class="bg-dark">Hardware and accessories</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Software revenue</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Collectibles revenue</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Total Revenue</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Cost of sales</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Operating costs</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Operating income (losses)</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Interest income</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Unreal. gains (losses) BTC</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Net income</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Total cash</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                        <tr><td class="bg-dark">Total debt</td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td><td class="crunk-blue"></td></tr>
                    </table>
                </div>
                ...
                hist_data = [
                    {"p": "FY 2025", "ee": 0.84, "ae": 1.18, "er": "4.16B", "ar": "3.63B", "fy": True},
                    ...
                    {"p": "FY 2024", "ee": 0.07, "ae": 0.33, "er": "4.02B",  "ar": "3.82B",  "fy": True},
                    {"p": "Q4 2024", "ee": 0.08, "ae": 0.30, "er": "1.48B",  "ar": "1.28B",  "fy": False},
                    {"p": "Q3 2024", "ee": -0.03, "ae": 0.06, "er": "887.7M", "ar": "860.3M", "fy": False},
                    {"p": "Q2 2024", "ee": -0.09, "ae": 0.01, "er": "895.7M", "ar": "798.3M", "fy": False},
                    {"p": "Q1 2024", "ee": -0.09, "ae": -0.12, "er": "995.3M",  "ar": "881.8M", "fy": False},
                    {"p": "FY 2023", "ee": 0.13, "ae": 0.06, "er": "5.53B",  "ar": "5.27B",  "fy": True},
                    {"p": "Q4 2023", "ee": 0.29, "ae": 0.22, "er": "2.05B",  "ar": "1.79B",  "fy": False},
                    {"p": "Q3 2023", "ee": -0.08, "ae": -0.01, "er": "1.18B",  "ar": "1.08B",  "fy": False},
                    {"p": "Q2 2023", "ee": -0.14, "ae": -0.03, "er": "1.14B",  "ar": "1.16B",  "fy": False},
                    {"p": "Q1 2023", "ee": -0.12, "ae": -0.14, "er": "1.36B",  "ar": "1.24B",  "fy": False},
                    {"p": "FY 2022", "ee": -1.31, "ae": -1.02, "er": "5.88B",  "ar": "5.93B",  "fy": True},
                    {"p": "Q4 2022", "ee": -0.13, "ae": 0.16, "er": "2.18B",  "ar": "2.23B",  "fy": False},
                    {"p": "Q3 2022", "ee": -0.28, "ae": -0.31, "er": "1.35B",  "ar": "1.19B",  "fy": False},
                    {"p": "Q2 2022", "ee": -0.38, "ae": -0.35, "er": "1.27B",  "ar": "1.14B",  "fy": False},
                    {"p": "Q1 2022", "ee": -0.36, "ae": -0.52, "er": "1.32B",  "ar": "1.38B",  "fy": False},
                    {"p": "FY 2021", "ee": -0.42, "ae": -1.14, "er": "5.92B",  "ar": "6.01B",  "fy": True},
                    {"p": "Q4 2021", "ee": 0.21, "ae": -0.47, "er": "2.22B",  "ar": "2.25B",  "fy": False},
                    {"p": "Q3 2021", "ee": -0.13, "ae": -0.35, "er": "1.19B",  "ar": "1.30B",  "fy": False},
                    {"p": "Q2 2021", "ee": -0.17, "ae": -0.19, "er": "1.12B",  "ar": "1.18B",  "fy": False},
                    {"p": "Q1 2021", "ee": -0.21, "ae": -0.11, "er": "1.16B",  "ar": "1.28B",  "fy": False},
                    {"p": "FY 2020", "ee": -0.54, "ae": -0.54, "er": "5.18B",  "ar": "5.09B",  "fy": True},
                    ...
                    {"p": "Q4 2019", "ee": 0.29, "ae": 0.32, "er": "2.24B",  "ar": "2.19B",  "fy": False},
                    {"p": "Q3 2019", "ee": 0.03, "ae": -0.12, "er": "1.62B",  "ar": "1.44B",  "fy": False},
                    {"p": "Q2 2019", "ee": -0.05, "ae": -0.08, "er": "1.34B",  "ar": "1.29B",  "fy": False},
                    {"p": "Q1 2019", "ee": -0.01, "ae": 0.02, "er": "1.64B",  "ar": "1.55B",  "fy": False}
                ]
