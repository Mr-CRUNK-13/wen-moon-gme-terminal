...
# --- 3. TERMINAL & LIVE ENGINE ---
    ...
    tab1, tab2, tab3, tab4, tab5, tab6, tab7 = st.tabs(["📊 GME", "📜 WARRANTS", "🇺🇸 US", "📋 DATA", "🌕 WEN MOON US", "🗃️ WEN MOON DATA", "🏆 LEADERBOARD"])
    ...
    def render_content():
        plt.close('all') # KILL CACHE COMPLETELY - ZERO DUPLICATION
        
        # PULL LIVE DATA INSIDE THE FRAGMENT
        ...
        with tab3:
            ...
            ac.set_xlim(-2.5, 2.5) # FIX ARROWS CROPPING
        ...
        with tab5:
            ...
            ac_c.set_xlim(-2.5, 2.5) # FIX ARROWS CROPPING
        ...
        # --- 7TH TAB : LEADERBOARD INSIDE TERMINAL ---
        with tab7:
            u_name = st.session_state.get("ape_name", "Anonymous")
