...
# --- 3. TERMINAL & LIVE ENGINE ---
    ...
    with tab16:
        ...
        components.html("""<iframe width="100%" height="240" src="https://www.youtube.com/embed/videoseries?list=PL8E5BqjEa7V0KYhYAq18oYJ6GVMTFKZyR" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen style="border-radius:10px; border:2px solid #FF0000; box-shadow: 0 0 15px rgba(255,0,0,0.5);"></iframe>""", height=250)
